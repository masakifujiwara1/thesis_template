...
\section{ナビゲーションにおける予測結果の利用方法}
\figref{Fig:global-costmap}に示すように，グローバルコストマップに独自のレイヤであるMarker Array Layerを追加した．このレイヤで予測結果を受け取り，コストマップに反映する．グローバルコストマップを拡張したのは，\ref{sec:navigation-stack}節で述べたように，多くのロボットで使用されるNavigation Stackで予測結果を容易に利用できるようにするためである．
