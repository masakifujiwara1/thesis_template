...
\begin{figure}[hbtp]
    ...
    \includegraphics[keepaspectratio, scale=0.55]
         {images/s-lstm.png}
    \caption{Overview of Social-LSTM method (source: \cite{s-lstm})}
    \label{Fig:s-lstm}
\end{figure}
...
\begin{figure}[hbtp]
    ...
    \caption{Framework overview of proposed SR-LSTM (source: \cite{sr-lstm})}
...
\begin{figure}[hbtp]
    ...
    \includegraphics[keepaspectratio, scale=0.6]
         {images/sr-lstm.png}
    \caption{Illustration of the pedestrian-wise attention (source: \cite{sr-lstm})}
    \label{Fig:sr-lstm}
\end{figure}
...
\begin{figure}[hbtp]
    ...
    \includegraphics[keepaspectratio, scale=0.4]
         {images/s-bigat.png}
\caption{Illustration of the pedestrian-wise dependencies (source: \cite{s-bigat})}
    \label{Fig:s-bigat}
\end{figure}
...
\begin{figure}[hbtp]
    ...
    \includegraphics[keepaspectratio, scale=0.39]
         {images/s-stgcnn.png}
    \caption{The Social-STGCNN model (source: \cite{s-stgcnn})}
    \label{Fig:s-stgcnn}
\end{figure}
...
\begin{figure}[hbtp]
    ...
    \caption{Encoder structure (source: \cite{si2023-tanno})}
